...
public class ImportItemSingleView extends ImportItemView {
    ...
    public ImportItemSingleView(Context context, ImportItem item) {
        super(context);
        View.inflate(context, R.layout.import_list_single_item, this);
        ...
        mBtnCheckbox.setOnCheckedChangeListener(new ToggleImageButton.OnCheckedChangedListener() {
            ...
            public void onCheckedChange(boolean value) {
                if (mCallback != null) {
                    mCallback.onCheckedChange(ImportItem.ImportItemType.SINGLE_ITEM, getTag(), value);
                }
            }
        });
    }
