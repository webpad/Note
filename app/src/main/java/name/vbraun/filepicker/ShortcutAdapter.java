...
public class ShortcutAdapter extends ArrayAdapter<Shortcut> {
	...
	public ShortcutAdapter(Context context) {
		...
		addShortcut("SD card",          R.drawable.filepicker_shortcut_sdcard, Type.ORDINARY_DIR, Global.PATH_SDCARD);
		...
		addShortcut("Downloads",        R.drawable.filepicker_shortcut_folder, Type.ORDINARY_DIR, Global.PATH_SDCARD + "/Download");
		addShortcut("Music",            R.drawable.filepicker_shortcut_folder, Type.ORDINARY_DIR, Global.PATH_SDCARD + "/Music");
		addShortcut("Movies",           R.drawable.filepicker_shortcut_folder, Type.ORDINARY_DIR, Global.PATH_SDCARD + "/Movies");
		addShortcut("Pictures",         R.drawable.filepicker_shortcut_folder, Type.ORDINARY_DIR, Global.PATH_SDCARD + "/Pictures");
	}
