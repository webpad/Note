...
abstract public class Artist {
	...
	abstract public void circle(float x, float y, float r);
	abstract public void ellipse(float x, float y, float xr, float yr);
	...
	abstract public void imageBackground(File jpgFile, float left, float right, float top, float bottom);
	abstract public Page getPdf();
}
