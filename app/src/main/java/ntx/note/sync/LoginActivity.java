...
public class LoginActivity 
	...
	public final static String EXTRA_NAME = NoteAccount.EXTRA_NAME;
	public final static String EXTRA_EMAIL_ADDRESS = NoteAccount.EXTRA_EMAIL_ADDRESS;
	public final static String EXTRA_PASSWORD = NoteAccount.EXTRA_PASSWORD;
	...
	public void onLoadFinished(Loader<LoginLoader.Response> loader, LoginLoader.Response response) {
		...
		final Account account = new Account(email_str, NoteAccount.ACCOUNT_TYPE);
